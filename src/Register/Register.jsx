        ...
        <div className='w-full h-screen flex items-start'>
            <div className='relatif w-1/2 h-full hidden md:block'>
                <div className='absolute text-white top-[15%] left-[4%]'>
                    <h1 className='font-primary text-[23px] md1:text-[25px]  lg:text-[28px] lg1:text-[33px]'>Experience the Ease of Food Delivery</h1>
            ...
            <div className='w-full md:w-1/2 h-full flex flex-col p-20  md:max-w-[550px]  mx-auto justify-between items-center'>
                ...
                <div className='w-full flex flex-col mb-5'>
                    <div className='w-full flex flex-col mb-2'>
                        ...
                        <p className='mb-2'>Register now to start enjoying delicious food orders!</p>
                    </div>
                    ...
                    <div className='w-full'>
                        <button onClick={handleSubmit} className='w-full bg-red-500 p-2 rounded-md text-white mt-10'>Register</button>
                    </div>
                </div>
                <div className='w-full flex justify-center items-center '>
                    <p className=' text-sm'> Already have an account? <Link to="/login" className=' underline underline-offset-2 font-semibold'>Log in</Link></p>
                </div>
