...
const Cart = () => {
  ...
  const removeFromCart = (itemId) => {
    ...
    triggerDelete ? setTriggerDelete(false) : setTriggerDelete(true);
  };
  ...
  return (
    <div>
      <Navbar
        background="bg-black bg-opacity-40 pt-3 z-50"
        triggerDelete={triggerDelete}
      />
      <div className="mb-[100px] lg:mb-[145px]">
        {showPayment && <Payment show={showPayment} />}
        {cartItems.length === 0 ? (
          <p className="h-screen flex justify-center items-center text-[30px]">
            Your cart is empty.
          </p>
        ) : (
            ...
            <div className="h-1/2 p-4 flex flex-col justify-center lg:h-screen lg:w-1/2 lg:px-20 mt-5 lg:mt-0 lg:pt-20 sticky top-0">
              <div className="border rounded-lg border-opacity-40 border-gray-400 bg-gray-100 lg:-ml-[80px] lg:-mt-[50px] p-10 h-[300px] flex flex-col justify-center  gap-4">
                ...
                <button
                  ...
                  className="bg-red-500 text-white p-3 rounded-md w-1/2 self-end font-bold hover:bg-red-600"
                >
                  Pay Now
                </button>
              </div>
